...
/*
{
  "username": "brunokhaos",
  "password": "123456",
  "request_token": "edc71fb6561f037f7d94a05f096b227c4afa960d"
} */
//var apiKey = 'a6e2d1410cfa4bceeccee4df08398946';
//token = edc71fb6561f037f7d94a05f096b227c4afa960d
let listId = '7101979';
...
/*Funções implementadas nos inputs, para realizar a verificação do preenchimento. */
...
/*Verifica se todos os campos foram preenchidos, após remove a classe do botao, permitindo logar. */
...
searchButton?.addEventListener('click', async () => {
  let lista = document.getElementById("lista") as HTMLLIElement;
  if (lista) {
    lista.outerHTML = "";
  }
  let query = (<HTMLInputElement> document.getElementById('search')).value;
  let listaDeFilmes = await <any>procurarFilme(query);
...
async function criarRequestToken () {
  let result = await <any>HttpClient.get({
